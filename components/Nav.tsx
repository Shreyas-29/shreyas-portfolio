        ...
        <div className='flex items-center justify-center max-w-xs md:max-w-md absolute bottom-8 left-0 right-0 mx-auto rounded-lg navbar space-x-6 md:space-x-5 py-4 md:py-2'>
            <a href={'#home'} className='relative group'>
                <div className='flex items-center flex-col p-0 md:p-2'>
                    <HiHome className={`w-6 h-6 group-hover:text-violet-900 ${active ? 'text-violet-900' : 'text-violet-700'}`} />
            ...
            <a href={'#about'} className='relative group'>
                <div className='flex items-center flex-col p-0 md:p-2'>
                    <BsPersonFill className={`w-6 h-6 group-hover:text-violet-900 ${active ? 'text-violet-900' : 'text-violet-700'}`} />
            ...
            <a href={'#services'} className='relative group'>
                <div className='flex items-center flex-col p-0 md:p-2'>
                    <RiServiceFill className={`w-6 h-6 group-hover:text-violet-900 ${active ? 'text-violet-900' : 'text-violet-700'}`} />
            ...
            <a href={'#work'} className='relative group'>
                <div className='flex items-center flex-col p-0 md:p-2'>
                    <MdWork className={`w-6 h-6 group-hover:text-violet-900 ${active ? 'text-violet-900' : 'text-violet-700'}`} />
            ...
            <a href={'#skills'} className='relative group'>
                <div className='flex items-center flex-col p-0 md:p-2'>
                    <FaAward className={`w-6 h-6 group-hover:text-violet-900 ${active ? 'text-violet-900' : 'text-violet-700'}`} />
            ...
            <a href={'#contact'} className='relative group'>
                <div className='flex items-center flex-col p-0 md:p-2'>
                    <IoChatboxEllipses className={`w-6 h-6 group-hover:text-violet-900 ${active ? 'text-violet-900' : 'text-violet-700'}`} />
